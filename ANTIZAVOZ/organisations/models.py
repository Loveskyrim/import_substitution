...
class organisation(models.Model):
    ...
    organisation_description = models.CharField(max_length=8, verbose_name=u"Описание", blank=True)
...
class product(models.Model):
    ...
    product_info = models.CharField(max_length=8, verbose_name=u"Информация о продукте", blank=True)
