...
class organisation(models.Model):
    ...
    organisation_okved = models.CharField(max_length=100, verbose_name=u"Вид деятельности", blank=True)
    ...
    organisation_link = models.TextField(verbose_name=u"Ссылка", blank=True)
